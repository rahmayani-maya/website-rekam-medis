            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" name="nama" placeholder="Nama Pasien" value="<?= $pasien['nama'] ?>" required>
                    </div>
                    <div class="form-group mb-3">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="tel" class="form-control" name="telpon" id="telpon" placeholder="Telpon Pasien" pattern="[0-9]{8,}" title="minimal 8 angka" value="<?= $pasien['telpon'] ?>" required>
                    </div>
                    <div class="form-group mb-3">
